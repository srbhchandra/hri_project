...
if("TRUE" STREQUAL "TRUE")
  set(face_recognition_SOURCE_PREFIX /home/turtlebot/hri_project/turtlebot_ds/src/face_recognition)
  set(face_recognition_DEVEL_PREFIX /home/turtlebot/hri_project/turtlebot_ds/devel)
  ...
  set(face_recognition_INSTALL_PREFIX /home/turtlebot/hri_project/turtlebot_ds/install)
...
if(NOT "/home/turtlebot/hri_project/turtlebot_ds/devel/include " STREQUAL " ")
  set(face_recognition_INCLUDE_DIRS "")
  set(_include_dirs "/home/turtlebot/hri_project/turtlebot_ds/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'face_recognition' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'turtlebot <turtlebot@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'face_recognition' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/turtlebot/hri_project/turtlebot_ds/src/face_recognition/${idir}'.  Ask the maintainer 'turtlebot <turtlebot@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/turtlebot/hri_project/turtlebot_ds/devel/lib;/home/turtlebot/hri_project/turtlebot_ds/devel/lib;/home/turtlebot/turtlebot_ws/devel/lib;/opt/ros/indigo/lib)
