...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'face_recognition' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/turtlebot/hri_project/turtlebot_ds/install/${idir}'.  Ask the maintainer 'turtlebot <turtlebot@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/turtlebot/hri_project/turtlebot_ds/install/lib;/home/turtlebot/hri_project/turtlebot_ds/devel/lib;/home/turtlebot/turtlebot_ws/devel/lib;/opt/ros/indigo/lib)
